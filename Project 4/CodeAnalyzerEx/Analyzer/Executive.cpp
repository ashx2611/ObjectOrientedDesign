/////////////////////////////////////////////////////////////////////
// Executive.cpp - Directs Code Analysis.Displays implementation of the
...
void CodeAnalysis::CodeAnalysisExecutive::requirements()
{
	cout << "\n"<<"*********************Requirement 1*****************************" << endl;
	cout << "****************Using Visual Studio 2015 and its C++ Windows Console Projects*******"<<endl;
	cout << "\n" << "*********************Requirement 2*****************************" << endl;
	cout << "****************Using the C++ standard library's streams for all I/O and delete for all heap-based memory management*******" << endl;
}

void CodeAnalysis::CodeAnalysisExecutive::requirementsproj3()
{
	
	cout << "\n" << "*********************Requirement 3*****************************" << endl;
	cout << "Publisher  provides creation of web pages each of which captures the content of a single C++ source code file, e.g., *.h or *.cpp." << endl;
	cout << "\n" << "*********************Requirement 4*****************************" << endl;
	cout << "The pages have hide/unhide facility for expanding and collapsing bodies of classes, methods and global functions" << endl;
	cout << "\n" << "*********************Requirement 5*****************************" << endl;
	cout << "Included CSS Style sheet and java script file which is used by the Publisher" << endl;
	 cout << "\n" << "*********************Requirement 6*****************************" << endl;
	 cout << "The webpages head section contains links to style sheet and Java Script files used" << endl;
	  cout << "\n" << "*********************Requirement 7*****************************" << endl;
	 cout << "The links to the dependent files are present on top of the web page retrieved from dependency table" << endl;
	 cout << "\n" << "*********************Requirement 8*****************************" << endl;
	 cout << "Command line proceses arguments and publishes specific paths and .*h and .*cpp patterns" << endl;
	 cout << "\n" << "*********************Requirement 9*****************************" << endl;
	 cout << "The code runs on the Analyzer folder which contains the important packages" << endl;
	 cout << "\n" << "*********************Requirement 10*****************************" << endl;
	 cout << "The executive demonstrates all the requirements" << endl;
	 

}
//function to publish files on server
void CodeAnalysis::CodeAnalysisExecutive::integrate(int argc, char *argv[])
{
	...
	typetable = ta.doTypeAnal();//display type table
	dt.getTypetable(typetable);//get populated typetable
	dt.DFS(); //dependency table
	dt.doDFS();
	NoSqlDb<string> tempdb = dt.getdb();
	temp = dt.getdeptable();
	PublishFiles p(temp); //passing the details of deptable and initializing it.
	p.generatecss();//creating css file for styling the published code
	p.Publishcode();//Displaying source code in browser	
}
