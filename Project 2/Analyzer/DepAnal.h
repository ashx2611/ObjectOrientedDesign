...
*  - xmlpersist.h, xmlpersist.cpp
*  - XMLDocument.h, XMLDocument.cpp
*
*  Functions:
*  ---------------
*  void insertintable(CodeAnalysis::ASTNode *pNode);  --inserts the name and type and filename associated with each class,struct,enum and using
*  void display();  --displays the type table
*  string getName(){return name1;} --getter function for Name of class/struct/enum/using
*  string  TypeTable::getFileName() { return filename1; }--getter function for FileName
*  string  TypeTable::getTypeName() {return typename1;}--getter function for TypeName
