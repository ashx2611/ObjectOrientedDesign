...
public:
	...
	void insertintoTTable(CodeAnalysis::ASTNode* pNode)
	{
		...
		if (pNode->type_ == "class" || pNode->type_ == "struct" || pNode->type_ == "enum" || pNode->type_ == "typedef" || pNode->type_ == "using" || pNode->type_ == "function")
		{
	...
	void display()
	{
		cout << "\n " << setw(20) << "Name" << setw(15) << "Type" << setw(20) << "FileName" << "\n";
